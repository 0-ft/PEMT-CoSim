...
class AUCTION:
    ...
    def aggregate_bids(self):
        ...
        self.agg_unres_seller, self.agg_resp_max_seller, self.agg_deg_seller, self.agg_c2_seller, self.agg_c1_seller = helpers.aggregate_bid(
            self.curve_seller)
            ...
            if check:
                ...
                if supply_quantity == demand_quantity:
                    ...
                    if i == self.curve_buyer.count or j == self.curve_seller.count:
                        self.clearing_type = ClearingType.EXACT if a == b else ClearingType.PRICE
    ...
    def calculate_surplus(self, tnext_clear=0, time_granted=0):
        ...
        print(
            f"auction: time {time_granted}, clearing price {self.clearing_price:.3f}, {self.curve_buyer.count} buyers, {self.curve_seller.count} sellers")
        # print('##',
        #       time_granted,
        #       tnext_clear,
        #       self.clearing_type,
