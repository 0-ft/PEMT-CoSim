...
#        print (ts,'resp_max updated before', helics.helicsInputIsUpdated(sub_max))
        resp_max = helics.helicsInputGetComplex(sub_max).real * load_scale  # TODO: pyhelics needs to return complex instead of tuple
#        print (ts,'resp_max updated after', helics.helicsInputIsUpdated(sub_max))
      ...
      if (sub_load is not None) and helics.helicsInputIsUpdated(sub_load):
        gld_load = helics.helicsInputGetComplex(sub_load)  # TODO: pyhelics needs to return complex instead of tuple
