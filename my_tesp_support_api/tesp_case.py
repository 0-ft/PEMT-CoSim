...
def write_tesp_case(config, cfgfile, freshdir=True):
    ...
    if freshdir == True:
        ...
        cmdline = pycall + """ -c "import tesp_support.api as tesp;tesp.weathercsv('""" + weatherfile + """','""" + casedir + '/weather.dat' + """','""" + StartTime + """','""" + EndTime + """',""" + str(
            WeatherYear) + """)" """
        print(cmdline)
        #    quit()
...
"""
        ...
        epPubs.append({"global": False, "key": "WHOLE BUILDING Facility Total Electric Demand Power", "type": "double",
                       "unit": "W"})
        epPubs.append(
            {"global": False, "key": "WHOLE BUILDING Facility Total HVAC Electric Demand Power", "type": "double",
             "unit": "W"})
        epPubs.append({"global": False,
                       "key": "FACILITY Facility Thermal Comfort ASHRAE 55 Simple Model Summer or Winter Clothes Not Comfortable Time",
                       "type": "double", "unit": "hour"})
        epPubs.append({"global": False, "key": "Environment Site Outdoor Air Drybulb Temperature", "type": "double",
                       "unit": "degC"})
        ...
        epaSubs.append({"key": "energyPlus/EMS Heating Controlled Load", "type": "double", "required": True,
                        "info": "heating_controlled_load"})
        epaSubs.append({"key": "energyPlus/EMS Cooling Controlled Load", "type": "double", "required": True,
                        "info": "cooling_controlled_load"})
        epaSubs.append({"key": "energyPlus/EMS Cooling Schedule Temperature", "type": "double", "required": True,
                        "info": "cooling_schedule_temperature"})
        epaSubs.append({"key": "energyPlus/EMS Heating Schedule Temperature", "type": "double", "required": True,
                        "info": "heating_schedule_temperature"})
        epaSubs.append({"key": "energyPlus/EMS Cooling Setpoint Temperature", "type": "double", "required": True,
                        "info": "cooling_setpoint_temperature"})
        epaSubs.append({"key": "energyPlus/EMS Heating Setpoint Temperature", "type": "double", "required": True,
                        "info": "heating_setpoint_temperature"})
        epaSubs.append({"key": "energyPlus/EMS Cooling Current Temperature", "type": "double", "required": True,
                        "info": "cooling_current_temperature"})
        epaSubs.append({"key": "energyPlus/EMS Heating Current Temperature", "type": "double", "required": True,
                        "info": "heating_current_temperature"})
        epaSubs.append({"key": "energyPlus/EMS Cooling Power State", "type": "string", "required": True,
                        "info": "cooling_power_state"})
        epaSubs.append({"key": "energyPlus/EMS Heating Power State", "type": "string", "required": True,
                        "info": "heating_power_state"})
        epaSubs.append(
        ...
        epaSubs.append({"key": "energyPlus/WHOLE BUILDING Facility Total Electric Demand Power", "type": "double",
                        "required": True, "info": "electric_demand_power"})
        epaSubs.append({"key": "energyPlus/WHOLE BUILDING Facility Total HVAC Electric Demand Power", "type": "double",
                        "required": True, "info": "hvac_demand_power"})
        epaSubs.append({
                           "key": "energyPlus/FACILITY Facility Thermal Comfort ASHRAE 55 Simple Model Summer or Winter Clothes Not Comfortable Time",
                           "type": "double", "required": True, "info": "ashrae_uncomfortable_hours"})
        epaSubs.append(
            {"key": "energyPlus/Environment Site Outdoor Air Drybulb Temperature", "type": "double", "required": True,
             "info": "outdoor_air"})
        epaPubs = []
...
"""
    if freshdir == True:
        ...
        ppSubs.append({"name": "RESPONSIVE_DEG", "key": "sub1/responsive_deg", "type": "int64"})
        ppPubs = []
